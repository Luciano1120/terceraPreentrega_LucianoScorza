...
urlpatterns = [
    ...
    path("listaItem/", ListaItem.as_view()), # a diferencia de las views basadas en funciones de agrega el nombre de la clase.as_view()
    path("agregaItem/", CreaItem.as_view()), 
